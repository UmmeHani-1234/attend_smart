...
// Type definitions
const GroupedBarChartDataPointShape = {
  key: '',
  data: [{ key: '', data: 0 }],
};

const LegendItemShape = {
  name: '',
  color: '',
};

const TimePeriodOptionShape = {
  value: '',
  label: '',
};

const IncidentStatShape = {
  id: '',
  title: '',
  count: 0,
  countFrom: 0,
...
// SVG Icon Components
const DiamondAlertIcon = ({ className, fill = "#E84045" }) => (
...
const CircleAlertIcon = ({ className, fill = "#E84045" }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
const TriangleAlertIcon = ({ className, fill = "#E84045" }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
const DetailedTrendUpIcon = ({ baseColor, strokeColor, className }) => (
...
const DetailedTrendDownIcon = ({ baseColor, strokeColor, className }) => (
  <svg className={className} width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="28" height="28" rx="14" fill={baseColor} fillOpacity="0.4" />
...
const initialMultiCategorySmallBlock = [
  {
    key: 'Firewall',
    data: [
...
const validateGroupedBarChartData = (data) => {
...
const DETAILED_METRICS_DATA = [
  ...
  },
  {
    ...
    tooltip: 'Mean Time to Resolve',
    value: '1d 4h',
    TrendIcon: DetailedTrendDownIcon,
    trendBaseColor: '#40E5D1',
    trendStrokeColor: '#2ED1B9',
    delay: 0.2,
    iconFillColor: '#2ED1B9',
  },
  {
    id: 'resolution-rate',
    Icon: TriangleAlertIcon,
    label: 'Resolution Rate',
    tooltip: 'Resolution Rate',
    value: '92%',
    TrendIcon: DetailedTrendUpIcon,
    trendBaseColor: '#40E5D1',
    trendStrokeColor: '#2ED1B9',
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Incident Analytics</h2>
          <p className="text-sm text-gray-500">Monitor and analyze security incidents</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        {INCIDENT_STATS_DATA.map((stat) => {
          const TrendIconComponent = stat.TrendIconSvg;
          return (
            <div key={stat.id} className="bg-gray-50 rounded-xl p-4">
              <div className="flex justify-between items-start">
                ...
                <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${stat.trendBgColor} ${stat.trendColor}`}>
                  <TrendIconComponent strokeColor={stat.trendColor.includes('#F08083') ? '#E84045' : '#2ED1B9'} />
                  <span>{stat.percentage}%</span>
                </div>
              </div>
              <p className="text-xs text-gray-500 mt-2">{stat.comparisonText}</p>
            </div>
          );
        })}
      </div>
        ...
        {DETAILED_METRICS_DATA.map((metric) => {
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-2">
                  <MetricIcon className="w-5 h-5" fill={metric.iconFillColor} />
      ...
      <div className="bg-gray-50 rounded-xl p-4">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-medium text-gray-900">Incidents by Category</h3>
            ...
            xAxis={
              <LinearXAxis
                ...
                tickSeries={
                  <LinearXAxisTickSeries
                    line={null}
                    label={<LinearXAxisTickLabel rotation={0} position="end" />}
                  />
                }
              />
            }
            yAxis={
              <LinearYAxis
                ...
                tickSeries={
                  <LinearYAxisTickSeries
                    line={null}
                    label={<LinearYAxisTickLabel padding={5} position="start" />}
                  />
                }
              />
            }
...
export default MultiSeriesBarBig;