...
const ClassroomCard = ({ 
  ...
  const getSubjectIllustration = () => {
    ...
    if (lowerTitle.includes('math')) {
      return (
        <svg className="w-24 h-24 text-white opacity-20" viewBox="0 0 100 100">
  ...
  return (
    <div 
      className="relative rounded-2xl shadow-lg overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl min-w-[280px] md:min-w-[300px] group"
      onClick={onClick}
    >
      {/* Gradient background */}
      <div className={`bg-gradient-to-br ${themeClasses[theme]} h-32 relative`}>
      ...
      <div className="bg-white p-5">
        ...
        <p className="text-gray-600 text-sm mb-3 line-clamp-1">{subtitle}</p>
